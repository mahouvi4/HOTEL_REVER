                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2 col-lg-8 offset-lg-2">
                        <div class="special_content">
                            <div class="details_title" style="color: rgb(20, 235, 255);font-family:cooper">Payment list !</div>
             ...
             <div class="row">
                ...
                <table class="table table-hover" style="box-shadow: 0 25px 25px rgba(3, 76, 94, 0.885)">
                    ...
                    <tbody>
                       @foreach ($pag as $item)
                       <tr>
                       <td class="mt-2" style="color: rgb(10, 171, 117);font-family:cooper">{{$item->fonctionaire->name_f.' '.$item->fonctionaire->firstname_f}}</td>
                        <td class="mt-2"> %{{$item->prime_p}}</td>
                        <td class="mt-2" style="color: rgba(237, 242, 244, 0.996);font-family:cooper">$ {{$item->salaire_Net}}</td>
                        @if ($item->statut==0)
                         <td class="mt-2" style="color: rgb(247, 41, 124);font-family:cooper">Unpaid</td>
                          @else
                          <td class="mt-2" style="color: rgb(41, 247, 65);font-family:cooper">Paid</td>

           
                         @endif

                        <td class="mt-2" style="color: rgb(41, 209, 247);font-family:cooper">{{$item->date_p}}</td>
                       
                        <td>
                            <a href="#" style="color: rgb(255, 243, 20);font-family:cooper">Edit</a>
                            <a href="#" style="color: rgb(236, 22, 26);font-family:cooper">Delete</a>
                 ...
                 <div class="row">
                    <a href="{{url('template/show_list_f')}}"><button type="button" class="btn btn-primary oolo" style="margin-left:10px;margin-top:3%; font-family:cooper;background-color: rgb(11, 40, 47);color:cyan">Return</button>
                    </a> 
                 </div>
             </div>
             <div style="margin-left:95px ;margin-top:-30px"> {{$pag->links()}}</div>
