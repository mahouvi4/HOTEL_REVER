								  ...
								  <table class="table">
										...
										<tbody>
											<tr>
												   <div>
													<th>Room:</th>
												<td class="romo" style="color: gold; font-family:aharoni;font-size:19px">ROOM</td></div>
													<div>
														<th>Price:</th>
												<td class="kwe" style="color: azure; font-family:aharoni;font-size:19px">PRICE</td>
													</div>
													
													<div>
														<th>N_adult:</th>
												<td class="lazo" style="color: deeppink ;font-family:aharoni;font-size:19px">N_ADULT</td>
													</div>
												
													<div>
														<th>N_child:</th>
												<td class="laza" style="color: cyan;font-family:aharoni;font-size:19px">N_CHILDREN</td>
													</div>
												<div>
													<th>N_day:</th>
												<td class="prazo" style="color: chartreuse;font-family:aharoni;font-size:19px">N_DAY</td>
												<input type="hidden" class="tranx_nbj" name="tranx_nbj">
												</div>
												<div>
													<th>Total:</th>
												<td class="toto" style="color: rgb(117, 187, 231);font-size:25px;font-family:aharoni">TOTAL: €</td>
												</div>
												  @if (session('info_user'))
...
<script>
	 ...
	 <script>
        var date1,date2,day,nomo,prex,value;
